...
namespace AnimalShelterBlazorWA.Server.Data.Migrations
{
    ...
    [Migration("20200723124654_ChangeNameOfUrlField")]
    partial class ChangeNameOfUrlField
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnimalShelterBlazorWA.Server.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AnimalShelterBlazorWA.Shared.Animal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AnimalShelterBlazorWA.Shared.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Dogfood",
                            Price = 10.99m,
                            ProductImageUrl = "https://nl.m.wikipedia.org/wiki/Bestand:Hundefutter.jpg",
                            VatPercentage = 21
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AnimalShelterBlazorWA.Server.Models.ApplicationUser", null)
                        .WithMany()
